...
#---------------------------------------
output<-"Stdout_optPSO_5times1grp_2cp_macro_optSimplex_Schepps.r";
outputFIM<-"FIM_optPSO_5times1grp_2cp_macro_optSimplex_Schepps.txt";
...
protA<-list(c(0,2,4,6,8 ))
# protA<-list(c(0,0.4261114,2.2424354,4.9926298,7.9896336,1)) #33.40729
# protA<- list(c(0, 0.4242430, 2.2525151, 4.9959627,7.9986695,1)) #33.44691
# protA<- list(c(sort(a1$result[1,1:5]), a1$result[6])) # 34.33916
# protA<- list(c(sort(a1$result[2,1:5]), a1$result[6])) # 34.34757
# protA<- list(c(sort(a1$result[3,1:5]), a1$result[6])) # 34.35098
# 
# apply(a1$result[,1:5], 1, sort)
# round(a1$optimumValue, 4)
# protA<-list(c(0.00, 2,5, 8),c(0.00, 1,4, 8))
# protA<-list(c(0,2,3,4,6,8,8))
