funFIMem_ds2 <- function(equation,paramName,beta,o,sigma,t_group,Trand,d,PropSubjects,nbTot){
  ...
  x = c(3,8,1,2,4,5,6,7,9,10)
  
  test = M_F[x, x]
  # invmat = test[2:11,2:11] + 10e-100
  invmat = test[3:10,3:10]
  ...
  ans1 = test[1:2,1:2] - test[1:2,c(3:10)] %*% ginv(invmat) %*% t(test[1:2,c(3:10)])
